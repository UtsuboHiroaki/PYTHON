...
has_stock_code = hasattr(stock_3987, "stock_code")
setattr(stock_3987, "company_name", "ディ－ガイア")
delattr(stock_3987, "company_name")
get_company_name_result = getattr(stock_3987, "company_name", "会社名不明")
